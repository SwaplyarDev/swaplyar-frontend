...
import { FormularioDeSolicitud, FormularioDeSolicitudMovil } from '@/utils/assets/img-database';
...
const RequestPage = () => {
  ...
  return (
    <div className={`flex flex-col ${isMobile ? '' : 'md:flex-row'} justify-center items-center gap-8 py-10`}>
      {isMobile && (
        <RequestInfoBlock

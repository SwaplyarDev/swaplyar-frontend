    ...
    <>
      ...
      <div className="flex w-full justify-center overflow-x-hidden">
        <div className="container min-h-[100dvh]">
          <div className="relative flex h-full w-full bg-[url('/images/tlf_404_clear.png')] bg-contain bg-center-10px bg-no-repeat dark:bg-[url('/images/tlf_404_dark.png')] md:bg-[url('/images/clear-404.png')] md:bg-cover md:bg-center-80px md:dark:bg-[url('/images/dark-404.png')]">

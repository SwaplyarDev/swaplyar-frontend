              ...
              <div className="relative">
                <div className="flex items-start justify-between p-4">
                  <div className="flex-1">
                    ...
                    <p className="font-medium text-gray-700 dark:text-white">{transaccion.fecha}</p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div
                    className={`text-right ${transaccion.completada ? 'text-green-600 dark:text-green-300' : 'text-red-600'}`}
                  >
                    {transaccion.estado}
                  </div>
                ...
                {expandedId === index && (
                  <div className="px-4 pb-4 pt-1">
                    ...
                    <div className="mb-3 grid grid-cols-2 gap-y-1 border-b pb-3 text-sm">
                      ...
                      <div className="text-gray-500 dark:text-white">CBU/CVU/ALIAS</div>
                      <div className="text-right">{transaccion.detalles.cbu}</div>

                      <div className="text-gray-500 dark:text-white">DI/CUIT/CUIL:</div>

...
import SearchRequestAuth from '@/components/auth/searchRequestAuth/searchRequestAuth';
...
const SearchRequestPageAuth = () => {
  return <SearchRequestAuth />;
};

export default SearchRequestPageAuth;

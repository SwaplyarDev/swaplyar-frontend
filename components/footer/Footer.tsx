        ...
        <footer className="rs-wrapper-v4">
            <div className="one-info-footer grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="flex flex-col items-start">
                    <h4 className="text-gray-900 dark:text-white">Regístrate y disfruta de beneficios</h4>
            ...
            <div className="two-info-footer grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
                <div className="container-footer-icon-social flex space-x-4">
                    <a href="https://www.linkedin.com/in/oa-suarez" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" title="SwaplyAr CEO en LinkedIn">
                        <FontAwesomeIcon icon={faLinkedin} className="text-blue-500 hover:text-blue-700" />
                    </a>
                    <a href="https://www.instagram.com/swaplyar/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" title="SwaplyAr en Instagram">
                        <FontAwesomeIcon icon={faInstagram} className="text-pink-500 hover:text-pink-700" />
                    </a>
                    <a href="https://www.facebook.com/swaplyar/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" title="SwaplyAr en Facebook">
                        <FontAwesomeIcon icon={faFacebook} className="text-blue-700 hover:text-blue-900" />
                    </a>
                    <a href="https://wa.me/5491123832198" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" title="SwaplyAr en WhatsApp">
                ...
                <p className="text-gray-900 dark:text-white">Todos los derechos reservados © SWAPLYAR | Group OA</p>
            </div>
        </footer>
    );
}

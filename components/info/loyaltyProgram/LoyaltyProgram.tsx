...
function LoyaltyProgram() {
  ...
  return (
    <>
      <div className="relative mx-auto my-10 max-w-[1204px] px-4 font-textFont md:px-8 lg2:px-4 top-[92px] mb-[206px]">
        ...
        <div>
          ...
          <section className="relative mx-auto mt-10 flex w-[1202px] flex-col items-center gap-10 lg2:max-w-full lg2:flex-row">

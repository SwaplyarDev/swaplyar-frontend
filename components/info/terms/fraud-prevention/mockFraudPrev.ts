  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        text: '',
        list: [
          'Conoce con quién estás tratando, en especial si se trata de un premio o un regalo que tú no has solicitado. No confíes en mensajes como: "¡Felicitaciones, ganaste $1,000 en una lotería extranjera!" ',
          'Investiga la oferta para cerciorarte de que sea real.  Si parece demasiado buena para ser verdad, es probable que sea un engaño.',
          'Recuerda que transferir dinero es lo mismo que enviar efectivo. Cuando lo envías, no lo tienes más... y no puedes recuperarlo.',
        ],
      },
      {
        title: 'Nunca:',
        text: '',
        list: [
          'Envíes dinero a alguien que no conoces. ¡Nunca!',
          'Deposites un cheque de alguien que te dice que le envíes parte del dinero.',
          'Envíes dinero a un pariente en problemas sin verificar la historia.',
          'Haz preguntas para verificar la identidad de la persona.',
          'Envíes dinero para recibir dinero.',
        ],
      },
    ],
  },

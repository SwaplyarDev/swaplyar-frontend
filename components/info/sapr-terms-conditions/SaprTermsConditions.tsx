...
const SaprTermsConditions = () => {
  ...
  return (
    <div className="my-10 w-full max-w-5xl px-3 mx-auto">
          <h1 className="mb-6 text-3xl md:text-4xl font-sans font-sans">
          Términos y Condiciones de Programa de Fidelización
            ...
            <h2 className="text-2xl mb-4">1. Membresía</h2>
                <h2 className="text-[21px] mb-4">a. Elegibilidad</h2>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
                ...
                <h2 className="text-[21px] mb-4">b. Inscripción</h2>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
                ...
                <h2 className="text-[21px] mb-4">c. Obligaciones de la Membresía</h2>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 shadow rounded bg-gray-100 dark:bg-[rgb(69,69,69)]">
            <h2 className="text-[23px] mb-4">2. Beneficios y Recompensas</h2>
            
                <h3 className="text-[21px] mb-4">a. Descuento de Bienvenida</h3>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
                ...
                <h3 className="text-[21px] mb-4">b. Crédito por Quinta Transacción</h3>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
                ...
                <h3 className="text-[21px] mb-4">c. Estado Premier</h3>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
                ...
                <h3 className="text-[21px] mb-4">d. Gestión de Recompensas en Línea</h3>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
                    Como Miembro, podrá revisar su historial de transacciones y resumen de recompensas en línea.
                </p>
        
                <h3 className="text-[21px] mb-4">e. Transacciones Calificadas</h3>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 shadow rounded bg-gray-100 dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[23px] mb-4">3. Comunicaciones de Marketing</h2>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 shadow rounded bg-gray-100 dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[23px] mb-4">4. Privacidad</h2>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 shadow rounded bg-gray-100 dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[23px] mb-4">5. Contacto con SwaplyAr</h2>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 shadow rounded bg-gray-100 dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[23px] mb-4">6. Marcas Registradas</h2>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 shadow rounded bg-gray-100 dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[23px] mb-4">7. Sujeto a Cambios o Cancelación</h2>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 shadow rounded bg-gray-100 dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[23px] mb-4">8. Cesión</h2>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 shadow rounded bg-gray-100 dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[23px] mb-4">9. Ley Aplicable</h2>
                <p className="text-[16px] mb-4 text-gray-700 dark:text-gray-100">
            ...
            <div className="flex justify-center mb-4">
             <Link href="https://swaplyar.com/SAPR-Terms-Conditions-ES%20.pdf" target="_blank" className={`relative m-1 h-[48px] font-bold items-center justify-center rounded-3xl border border-buttonsLigth bg-buttonsLigth p-3 text-white dark:border-darkText dark:bg-darkText dark:text-lightText buttonSecond`}>
               Descargar Términos

  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
          ...
          Términos y Condiciones de Programa de Fidelización
            ...
            <h2 className="text-2xl font-bold mb-6">1. Membresía</h2>
                <h2 className="text-[24px] font-semibold mb-2">a. Elegibilidad</h2>
                ...
                <h2 className="text-[24px] font-semibold mb-2">b. Inscripción</h2>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
                ...
                <h2 className="text-[24px] font-semibold mb-2">c. Obligaciones de la Membresía</h2>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 bg-white shadow rounded dark:bg-[rgb(69,69,69)]">
            <h2 className="text-[24px] text-2xl font-semibold mb-2">2. Beneficios y Recompensas</h2>
            
                <h3 className="text-[24px] font-semibold mb-2">a. Descuento de Bienvenida</h3>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
                ...
                <h3 className="text-[24px] font-semibold mb-2">b. Crédito por Quinta Transacción</h3>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
                ...
                <h3 className="text-[24px] font-semibold mb-2">c. Estado Premier</h3>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
                ...
                <h3 className="text-[24px] font-semibold mb-2">d. Gestión de Recompensas en Línea</h3>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
                    Como Miembro, podrá revisar su historial de transacciones y resumen de recompensas en línea.
                </p>
        
                <h3 className="text-[24px] font-semibold mb-2">e. Transacciones Calificadas</h3>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 bg-white shadow rounded dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[24px] font-semibold mb-2">3. Comunicaciones de Marketing</h2>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 bg-white shadow rounded dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[24px] font-semibold mb-2">4. Privacidad</h2>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 bg-white shadow rounded dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[24px] font-semibold mb-2">5. Contacto con SwaplyAr</h2>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 bg-white shadow rounded dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[24px] font-semibold mb-2">6. Marcas Registradas</h2>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 bg-white shadow rounded dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[24px] font-semibold mb-2">7. Sujeto a Cambios o Cancelación</h2>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 bg-white shadow rounded dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[24px] font-semibold mb-2">8. Cesión</h2>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 bg-white shadow rounded dark:bg-[rgb(69,69,69)]">
                <h2 className="text-[24px] font-semibold mb-2">9. Ley Aplicable</h2>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">

        ...
        <div className="my-10 w-full max-w-5xl">
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-1">
            <div className="rounded-lg bg-gray-100 p-6 text-gray-900 shadow-md dark:bg-graytyc dark:text-gray-100">
              ...
              <h3 className="text-2xl md:text-2xl indent-6">
                a. Elegibilidad
              </h3>
              ...
              <h3 className="text-2xl md:text-2xl indent-6">
              c. Obligaciones de la Membresía
              </h3>
              <p className='ml-6'>
            ...
            <div className="rounded-lg bg-gray-100 p-6 shadow-md dark:bg-graytyc">
              ...
              <h3 className="text-2xl md:text-2xl indent-6">
              b. Crédito por Quinta Transacción
              </h3>
              <p className='ml-6 mb-4'>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-1">
              <div className="rounded-lg bg-gray-100 p-6 shadow-md dark:bg-graytyc">
                ...
                <p className='ml-6'>
                Puede contactar a SwaplyAr en línea en <strong><LinkWithHover href="/info/help-center">swaplyar.com/info/help-center</LinkWithHover></strong>, por <strong><LinkWithHover href="https://wa.me/+5491123832198">WhatsApp</LinkWithHover></strong>, o por correo de atención: <strong><LinkWithHover href="mailto:info@swaplyar.com">centrodeayuda@swaplyar.com</LinkWithHover></strong>.
                </p>
              </div>
            </div>

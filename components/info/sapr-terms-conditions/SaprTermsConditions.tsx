const SaprTermsConditions = () => {
  return (
    <div className="max-w-3xl mx-auto p-4">
            ...
            <div className="mb-4 p-4 bg-white shadow rounded dark:bg-gray-800">
                <h2 className="text-2xl font-semibold mb-2">3. Comunicaciones de Marketing</h2>
                <p className="text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 bg-white shadow rounded dark:bg-gray-800">
                <h2 className="text-2xl font-semibold mb-2">4. Privacidad</h2>
                <p className="text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 bg-white shadow rounded dark:bg-gray-800">
                <h2 className="text-2xl font-semibold mb-2">6. Marcas Registradas</h2>
                <p className="text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 bg-white shadow rounded dark:bg-gray-800">
                <h2 className="text-2xl font-semibold mb-2">7. Sujeto a Cambios o Cancelación</h2>
                <p className="text-gray-700 dark:text-gray-100">
            ...
            <div className="mb-4 p-4 bg-white shadow rounded dark:bg-gray-800">
                <h2 className="text-2xl font-semibold mb-2">8. Cesión</h2>
                <p className="text-gray-700 dark:text-gray-100">

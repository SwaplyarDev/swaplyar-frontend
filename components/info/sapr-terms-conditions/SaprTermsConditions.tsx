    ...
    <div className="max-w-3xl mx-auto p-4">
          ...
          Términos y Condiciones de Programa de Fidelización
            ...
            <h2 className="text-2xl mb-4">1. Membresía</h2>
                ...
                <h2 className="text-2xl mb-4">b. Inscripción</h2>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
                ...
                <h2 className="text-2xl mb-4">c. Obligaciones de la Membresía</h2>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
            ...
            <h2 className="text-2xl mb-4">2. Beneficios y Recompensas</h2>
                ...
                <h3 className="text-2xl mb-4">b. Crédito por Quinta Transacción</h3>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
                ...
                <h3 className="text-2xl mb-4">c. Estado Premier</h3>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
                ...
                <h3 className="text-2xl mb-4">d. Gestión de Recompensas en Línea</h3>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">
                    Como Miembro, podrá revisar su historial de transacciones y resumen de recompensas en línea.
                </p>
        
                <h3 className="text-2xl mb-4">e. Transacciones Calificadas</h3>
                <p className="text-[16px] text-gray-700 dark:text-gray-100">

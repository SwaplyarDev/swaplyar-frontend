          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-1">
            <div className="rounded-lg bg-gray-100 p-6 text-gray-900 shadow-md dark:bg-graytyc dark:text-gray-100">
              ...
              <p>
                ...
                reservas de los presentes T&C y sus eventuales modificaciones.
                Si no está de acuerdo con estos T&C, deberá abstenerse de
                utilizar el sitio. SwaplyAr se reserva el derecho de modificar
                los T&C en cualquier momento, siendo efectivas las
                modificaciones desde el momento de su publicación en el sitio
                web. Se recomienda a los USUARIOS revisar periódicamente los T&C
            ...
            <div className="rounded-lg bg-gray-100 p-6 shadow-md dark:bg-graytyc">
              ...
              <p>
                ...
                información adicional para cumplir con las normativas
                comerciales vigentes y garantizar la seguridad y legitimidad de
                las operaciones.
              </p>
              <p>
                SwaplyAr actúa como intermediario en la compra y venta de saldo
                de PayPal, proporcionando una plataforma segura y confiable para
                que los USUARIOS realicen sus transacciones. No obstante,
                SwaplyAr no es un banco ni una entidad financiera regulada por
                la Ley de Entidades Financieras 21.526, ni una casa de cambio.
                Por lo tanto, todas las transferencias y operaciones se realizan
                a través de entidades reguladas conforme a la normativa vigente
            ...
            <div className="rounded-lg bg-gray-100 p-6 shadow-md dark:bg-graytyc">
              ...
              <p>
                ...
                exacta en todo momento. En caso de proporcionar información
                falsa, inexacta o incompleta, SwaplyAr se reserva el derecho de
                suspender o cancelar su cuenta, así como de tomar las acciones
                legales correspondientes. La responsabilidad por cualquier daño
                o perjuicio resultante de la información falsa o inexacta
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-1">
              <div className="rounded-lg bg-gray-100 p-6 shadow-md dark:bg-graytyc">
                ...
                <p>
                  ...
                  momento de la transacción. Además, el USUARIO es responsable
                  de cualquier comisión adicional que pueda aplicar el sistema
                  de envío elegido.
                </p>
                <p>
                  <strong>Plataformas Aceptadas:</strong> Actualmente, SwaplyAr
                  opera únicamente con PayPal. Las plataformas o procesos
                  aceptados pueden variar y serán actualizados en el sitio web
                  de SwaplyAr conforme a la disponibilidad de servicios y
                ...
                <p>
                  ...
                  residencia. Se recomienda a los USUARIOS estar informados
                  sobre las normativas fiscales vigentes en su jurisdicción.
                </p>
                <p>
                  <strong>Tiempos de Procesamiento:</strong> Las transferencias
                  y acreditaciones pueden demorar entre 12 y 24 horas hábiles,
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-1">
              <div className="rounded-lg bg-gray-100 p-6 shadow-md dark:bg-graytyc">
                ...
                <p>
                  ...
                  accionar por parte de otro USUARIO, puede notificar el
                  problema mediante un ticket de soporte o correo electrónico.
                  SwaplyAr se compromete a investigar y responder a dichas
                  notificaciones dentro de los plazos indicados en su política
                ...
                <p>
                  ...
                  negligencias de terceros, incluidos los USUARIOS, proveedores
                  de servicios de pago o cualquier otra entidad involucrada en
                  la cadena de transacciones.
                </p>
                <p>
                  El USUARIO acepta que cualquier disputa, reclamo o
                  controversia que surja de o esté relacionada con estos T&C o
                  los servicios prestados por SwaplyAr se resolverá a través de
                  los mecanismos de resolución de conflictos establecidos en la
                  plataforma, sin perjuicio del derecho del USUARIO de recurrir
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-1">
              <div className="rounded-lg bg-gray-100 p-6 shadow-md dark:bg-graytyc">
                ...
                <p>
                  SwaplyAr se compromete a proteger la información personal de
                  los USUARIOS en cumplimiento de las leyes y regulaciones
                  aplicables en materia de protección de datos. Para más
                  detalles sobre cómo se recopila, utiliza y protege la
                  información personal, consulte nuestra{' '}
                ...
                <p>
                  ...
                  credenciales de acceso y de cualquier actividad realizada con
                  su cuenta. SwaplyAr no se responsabiliza por el uso no
                  autorizado de la cuenta del USUARIO ni por cualquier daño o
                  pérdida resultante de dicho uso.
                </p>
                <p>
                  ...
                  garantiza una seguridad absoluta, por lo que el USUARIO
                  reconoce y acepta los riesgos inherentes a la transmisión de
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-1">
              <div className="rounded-lg bg-gray-100 p-6 shadow-md dark:bg-graytyc">
                ...
                <p>
                  Los USUARIOS del sitio SwaplyAr se comprometen a no realizar
                  las siguientes acciones:
                </p>
                <p>
                  <strong>a)</strong> Publicar contenido ilegal, obsceno,
                  abusivo, difamatorio, injurioso, discriminatorio o contrario a
                  las buenas costumbres.
                </p>
                <p>
                  <strong>b)</strong> Enviar archivos o comunicaciones con
                  virus, troyanos, programas maliciosos o cualquier otra
                  característica capaz de dañar el funcionamiento de un sistema
                  informático.
                </p>
                <p>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-1">
              <div className="rounded-lg bg-gray-100 p-6 shadow-md dark:bg-graytyc">
                ...
                <p>
                  ...
                  para proteger su cuenta. La cuenta es personal e
                  intransferible, y el USUARIO es responsable por el acceso que
                  otorgue a terceros.
                </p>
                <p>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-1">
              <div className="rounded-lg bg-gray-100 p-6 shadow-md dark:bg-graytyc">
                ...
                <p>
                  SwaplyAr puede, a su discreción, ofrecer premios,
                  bonificaciones o descuentos a los USUARIOS por el uso de las
                  cuentas o la operativa. Estas promociones estarán sujetas a
                  los términos y condiciones específicos establecidos para cada
                  caso.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-1">
              <div className="rounded-lg bg-gray-100 p-6 shadow-md dark:bg-graytyc">
                ...
                <p>
                  ...
                  La cuenta y las operaciones realizadas en ella son personales
                  y deben ser gestionadas exclusivamente por el titular de la
                  cuenta.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-1">
              <div className="rounded-lg bg-gray-100 p-6 shadow-md dark:bg-graytyc">
                ...
                <p>
                  ...
                  recibido con los detalles de la solicitud. Para soporte
                  técnico o postventa, SwaplyAr ofrece los siguientes métodos de
                  contacto:
                </p>
                <p>
            ...
            <div className="rounded-lg bg-gray-100 p-6 shadow-md dark:bg-graytyc">
              ...
              <p>
                <strong>
                  Dirección de Defensa al Consumidor de la Ciudad de Buenos
                  Aires:
                </strong>
              ...
              <p>
                ...
                Sarmiento 1118, 5° piso (C1041AAX), Tel: 4383-8510/12/13/15.

      ...
      <DialogContent className={`border-none ${isDark ? 'bg-zinc-800 text-white' : 'text-black'} sm:max-w-md`}>
        ...
        <div className="mb-6 mt-4 space-y-4">
          <div className="space-y-2">
            ...
            <Input
              id="nombre"
              className={`border ${errors.name && touched.name ? 'border-red-500' : 'border-zinc-600'} bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0`}
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger
                id="nacionalidad"
                className={`border ${errors.nationality && touched.nationality ? 'border-red-500' : 'border-zinc-600'} bg-transparent focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0`}
              >
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              type="number"
              inputMode="numeric"
              className={`border ${errors.documentNumber && touched.documentNumber ? 'border-red-500' : 'border-zinc-600'} bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0`}
          ...
          <div className="space-y-2">
            ...
            <Input
              id="fecha"
              type="date"
              className={`border ${errors.birthDate && touched.birthDate ? 'border-red-500' : 'border-zinc-600'} bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0`}
          ...
          <div className="space-y-2">
            ...
            <Input
              id="apodo"
              className={`border ${errors.alias && touched.alias ? 'border-red-500' : 'border-zinc-600'} bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0`}

...
export default function TransactionCalculator() {
  ...
  return (
    <div className={`not-design-system flex w-full flex-col items-center`}>
      <div className="mat-card calculator-container lg-tablet:min-w-[500px] flex w-full flex-col items-center rounded-2xl bg-[#e6e8ef62] p-8 shadow-md dark:bg-calculatorDark dark:text-white">

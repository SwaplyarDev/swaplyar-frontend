...
import { BankDarkImg, BankImg,PayoneerUsdDarkImg,PayoneerUsdImg, PaypalDarkImg, PaypalImg, PixImg, TetherDarkImg, TetherImg, WiseUsdDarkImg, WiseUsdImg } from '@/utils/assets/imgDatabaseCloudinary';
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <div className="mt-2 flex items-center gap-2">
                  ...
                  ></span>
                  <span className="text-xs text-gray-500 dark:text-gray-400">{wallet.details[0].userAccount?.status ? 'Activa' : 'Inactiva'}</span>
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-2">
              {wallet.details[0].currency && (
                <div className="flex items-center justify-center rounded-full bg-blue-50 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400 p-1.5">

...
const ConversionInstructions = () => {
  return (
    <div className="lazyload-user-social flex w-full max-w-7xl flex-col-reverse items-center justify-between gap-4 space-y-4 py-8 md:flex-col lg2:flex-row lg2:space-x-4 lg2:space-y-0">
      <div className="steps flex max-w-xl flex-1 flex-col items-start pt-6 lg2:pt-8">

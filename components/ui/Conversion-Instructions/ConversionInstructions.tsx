...
const ConversionInstructions = () => {
  return (
    <section className="flex w-full max-w-7xl items-start lg:items-center justify-start lg:justify-between gap-4 space-y-4 py-0 flex-col lg:flex-row lg:space-x-4 lg:space-y-0 lg:py-5 px-0 sm:px-[57px] lg:px-0">
      <article className="steps flex w-[358px] sm:w-full sm:max-w-[590px] flex-1 flex-col items-start pt-6 md:pt-8 lg:max-w-[590px]">

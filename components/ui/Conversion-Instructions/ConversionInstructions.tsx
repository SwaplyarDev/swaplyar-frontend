...
const ConversionInstructions = () => {
  return (
    <section className="flex w-full max-w-7xl flex-col-reverse items-center justify-between gap-4 space-y-4 py-0 sm:flex-col lg:flex-row lg:space-x-4 lg:space-y-0 lg:py-5">

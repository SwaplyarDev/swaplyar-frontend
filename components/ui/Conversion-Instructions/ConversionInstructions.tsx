...
const ConversionInstructions = () => {
  return (
    <div className="lazyload-user-social flex w-full max-w-7xl flex-col items-center justify-between gap-4 space-y-4 py-8 lg-tablet:flex-row lg-tablet:space-x-4 lg-tablet:space-y-0">

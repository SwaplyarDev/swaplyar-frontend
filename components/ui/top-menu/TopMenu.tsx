                ...
                >
                  <Sidebar.Items className="flex h-full w-full flex-col justify-between pt-5">
                    ...
                    <Sidebar.ItemGroup className="block border-t-2 border-blue-800 px-2 dark:border-sky-500 md:hidden">
                      <Sidebar.Item
                        className={`relative m-1 h-[48px] items-center justify-center rounded-3xl border border-buttonsLigth p-3 text-buttonsLigth hover:bg-transparent dark:border-darkText dark:hover:bg-transparent ${logStyles.buttonLight}`}
                        onClick={() => {
                          handleSelect('login');
                          setView('login');
                          setDrawerMenu(false);

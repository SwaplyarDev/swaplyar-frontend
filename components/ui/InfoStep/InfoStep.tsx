    ...
    Swal.fire({
      html: ReactDOMServer.renderToString(
        <>
          ...
          <h2 className="mx-auto mt-14 max-w-[349px] font-titleFont text-xl font-semibold">
            No olvides tomar una captura de pantalla de tu comprobante.
          </h2>
          <div className="flex gap-[30px] px-[10px] pt-[38px] xs-mini-phone2:px-[38px]">
            <div className="flex w-full flex-col items-center gap-2">
              ...
              <p className="max-w-[158px] font-textFont text-xs text-lightText dark:text-darkText">
          ...
          <h2 className="mx-auto mt-[19px] max-w-[306px] font-titleFont text-xl font-semibold">
            ¡Guárdalo y asegúrate de tenerlo a la mano!
          </h2>
          <div id="accept-button-container"></div>
        </>,
      ),
      ...
      didRender: () => {
        ...
        if (backElement) {
          ...
          root.render(
            <button onClick={() => Swal.close()} className="absolute right-3 top-3">
      ...
      didOpen: () => {
        ...
        const acceptButtonContainer = document.getElementById('accept-button-container');
        if (acceptButtonContainer) {
          acceptButtonContainer.innerHTML = '';
          ...
          acceptButtonContainer.appendChild(button);
        }
      },
      willClose: () => {
        setIsTooltipVisible(false);

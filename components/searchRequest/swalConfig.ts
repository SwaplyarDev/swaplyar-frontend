...
export const showStatusAlert = (statuses: string[], isDark: boolean) => {
  Swal.fire({
    html: `
      <div class="w-full h-full items-center justify-center flex flex-col">
        <div>
          ...
          ${statuses
            .map(
              (message) => `
              <div class="w-[325px] flex justify-start items-start p-2">
              <li class="flex items-center gap-[17px] self-stretch">
            ...
            <button class="absolute top-2 right-2 text-white text-xl">
             <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                    ...
                    ${isDark ? `stroke="#EBE7E0" ` : `stroke="#252526" `}
    ...
    customClass: {
      popup: 'w-[387px] h-[380px] rounded-lg',
    },
    didRender: () => {

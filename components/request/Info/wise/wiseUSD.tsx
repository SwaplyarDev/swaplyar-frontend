            ...
            <p className="mb-4 text-center text-lg md:text-left">
              <ul className="space-y-2">
                ...
                <li>
                  ...
                  <span className="font-semibold text-buttonsLigth dark:text-sky-500">suarez.ICBC</span>
                </li>
                <li>
                  A nombre de: {''}
                  <span className="font-semibold text-buttonsLigth dark:text-sky-500">Johan Suarez</span>
                </li>
                <li>

    ...
    <div className="my-7 flex flex-col items-center justify-center px-4 md:px-8 lg2:px-4">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="mx-auto max-w-[679px] text-center font-textFont font-light lg2:max-w-[792px]">
          Completa los datos requeridos con precisión para iniciar tu solicitud de reembolso. Procesaremos tu pedido de
          forma segura y devolveremos el dinero a la cuenta de origen de manera eficiente y sin complicaciones.
        </p>
      </div>
